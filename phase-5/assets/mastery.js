...
(function (global) {
  ...
  function mount(root, catalog, courseVersion) {
    ...
    function renderTask() {
      ...
      if(!archive.exposure[t.source.overlapGroup]) { archive.exposure[t.source.overlapGroup]={firstSeen:now(),task:t.id}; save(); }
